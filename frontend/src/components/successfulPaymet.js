      ...
      <div className="login-form w-full max-w-[400px] bg-white rounded-lg shadow-lg p-6">
        <form className="flex flex-col gap-4">
          ...
          <div className="text-gray-700 text-center">
            <p>Gracias por tu compra. Si tienes alguna pregunta, no dudes en contactarnos a través de nuestro servicio de atención al cliente.</p>
          </div>
