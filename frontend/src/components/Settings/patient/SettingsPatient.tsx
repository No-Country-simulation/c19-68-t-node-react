    ...
    return (
        <div className="w-[430px] h-[932px] setting flex flex-col items-center p-4 ">
            ...
            <div className="w-full h-[500px] justify-between flex flex-col max-w-[350px] mx-auto z-20">
                ...
                <Link href={`/${rol}/${id}/payment-settings`} className="flex items-center">
                    <img className="w-[19px] h-[13px] mr-4" src="/settings/Vector.png" alt="Language" />
                    <span>Configuración de pagos</span>
                </Link>
                <Link href={`/${rol}/${id}/change-password`} className="flex items-center">
                ...
                <Link href={`/${rol}/${id}/delete-account`} className="flex items-center">
