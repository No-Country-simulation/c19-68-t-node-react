      ...
      >
        ...
        <label className="flex justify-between">
          ...
          <div className="flex items-end justify-between ">
            <span>Ciudad</span>
            {doctor?.doctor.city ? (
              <InputReadOnly type="string" value={doctor?.doctor.city} twClass="w-[120px]" />
            ) : (
              <input
                type="string"
                {...register("city")}
        ...
        doctor?.doctor.address && doctor?.doctor.dateOfBirth && doctor?.doctor.city &&  doctor?.doctor.country && doctor?.doctor.email && doctor?.doctor.idNumber && doctor?.doctor.idType && doctor?.doctor.postalCode ?
